...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "UPDATE jobs SET title = ?, description = ?, requirements = ?, location = ?, type = ?, status = ? WHERE id = ?";
    $stmt = $conn->prepare($query);
    $stmt->bind_param("ssssssi", $title, $description, $requirements, $location, $type, $status, $job_id);
...
<head>
    ...
    <title>Edit Job - TechBao Admin</title>
